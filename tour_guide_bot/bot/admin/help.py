...
class HelpCommandHandler(BaseHandlerCallback):
    ...
    async def waiting_contact_help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    async def waiting_token_help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        language = await self.get_language(update, context)
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            t(language).pgettext('admin-help', "You can use the following commands:\n"
